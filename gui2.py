...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\katka\Documents\tkinter design\Tkinter-Designer-master\build1\assets\frame2")
...
zoom_in_button = Button(window, text="3rd Year - Division 1", command=print("HE HE"), bg="#FF7147", fg="white")
zoom_in_button.place(x=10, y=150)

def show_excel_file():
    excel_data = pd.read_excel("3rd_Year_Division_1.xlsx")
    ...
    style.configure("Treeview", background="#2C4072")
...
def show_excel_file1():
    excel_data = pd.read_excel("3rd_Year_Division_2.xlsx")
